...
namespace Example.Locators {
    public class WrapLocator : Freezable, IItemsLocator {
        ...
        public static readonly DependencyProperty OrientationProperty =
            DependencyProperty.Register("Orientation", typeof(Orientation), typeof(WrapLocator), new PropertyMetadata(Orientation.Horizontal));
        ...
        protected override Freezable CreateInstanceCore() {
            return new WrapLocator { Orientation = this.Orientation };
        }
    }
}
